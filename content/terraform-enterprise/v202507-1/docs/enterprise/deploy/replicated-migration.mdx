...
last_modified: 2026-02-17T23:32:10.000Z
...
1. Follow the guide for [External Services to Kubernetes migration](/terraform/enterprise/deploy/replicated-migration#external-services-or-active-active-to-cloud-managed-kubernetes).
...
You must complete additional steps to migrate a Terraform Enterprise deployment on Replicated in [`disk` mode](/terraform/enterprise/deploy/configuration/storage/configure-mode):
