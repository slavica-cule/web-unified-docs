...
last_modified: 2026-02-17T22:54:45.000Z
...
~> **Important**: Back up your Terraform Enterprise data tier before proceeding. **If your organization has established backup procedures, follow those instead of the commands below.**
...
1. We recommend reusing your Replicated certificate to minimize the upgrade's effect on your other stack components.
   ...
   If you cannot access your certificate, key, or bundle file, you can retrieve them from the Replicated Terraform Enterprise container.
   Run the following command to list the certificate paths in the container:
